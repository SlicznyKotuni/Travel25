...
const PlannerHandler = (() => {
    ...
    const initGeneralCalendar = (data) => {
        ...
        new Sortable(assignedSections, {
            group: 'sections',
            animation: 150,
            //Funkcja onAdd jest wywoływana, gdy element jest dodawany do listy
            onAdd: function (evt) {
                ...
                if (!plannerData.selectedDay) {
                    alert('Wybierz dzień z kalendarza.');
                ...
                if (sectionType === 'section') {
                    ...
                    // Sprawdzenie, czy sekcja już istnieje w przypisaniach
                ...
                if (section.subsections && section.subsections.length > 0) {
                    ...
                    new Sortable(assignedSubsections, {
                        ...
                        onAdd: function (evt) {
                            ...
                            // Sprawdzenie, czy podsekcja już istnieje w przypisaniach
                ...
                if (section.images && section.images.length > 0) {
                    section.images.forEach(imageName => {
                        ...
                        try {
                            const img = new Image();
                            img.src = imagePath;
                            img.crossOrigin = "anonymous"; // Dodaj to
                            img.onload = () => {
